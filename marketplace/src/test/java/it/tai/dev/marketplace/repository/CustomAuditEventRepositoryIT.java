package it.tai.dev.marketplace.repository;

import it.tai.dev.marketplace.MarketplaceApp;
import it.tai.dev.marketplace.config.Constants;
import it.tai.dev.marketplace.config.audit.AuditEventConverter;
import it.tai.dev.marketplace.domain.PersistentAuditEvent;
...
import static it.tai.dev.marketplace.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
